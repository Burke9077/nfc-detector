...
def test_corner_back_factory_vs_nfc(data_path, work_path, models_path, resume=False, recalculate_lr=False, force_overwrite=False):
    """
    ...
    class_folders = {
        "factory": ["factory-cut-corners-backs"],
        "nfc": ["nfc-corners-backs"]
    }
    ...
    return run_classification_test(
        test_name="Factory vs NFC (Corner Back)",
